...
CREATE TABLE public.join_requests (
    ...
    UNIQUE(organization_id, user_id, status) -- Prevent duplicate pending requests
);
...
-- Function to assign next approver based on hierarchy
...
BEGIN
    ...
    -- If no current approver, start with creator's manager (reports_to)
    ...
    ELSE
        ...
        -- Escalate based on role hierarchy
